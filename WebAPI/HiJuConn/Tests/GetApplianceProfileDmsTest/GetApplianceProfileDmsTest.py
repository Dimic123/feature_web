...
def test_get_dms_appliance_property(token: str, params: dict):
    url = "https://clife-eu-gateway.hijuconn.com/dms/get_appliance_profile"
    ...
    assert all(k in data["response"] for k in ["resultCode", "applianceProfile"]), "Data structure is incorrect"
