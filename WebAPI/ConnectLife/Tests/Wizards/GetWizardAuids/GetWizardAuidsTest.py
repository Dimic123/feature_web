...
@pytest.mark.prod
def test_get_wizard_auids(token: str, params: dict):
    url = "https://api.connectlife.io/api/v1/wizard/" + ";".join(params["auids"])
...
def CreateJsonSchemas():
    ...
    err500Schema = CreateJsonSchema(
        "GET response schema for /api/v1/wizard/{auids} requests: ERROR 500", 
        "Wizard response schema", 
