...
@pytest.mark.prod
def test_post_wizard_washing_program_wizard_id(token: str, params: dict):
    url = "https://api.connectlife.io/api/v1/wizard/washing-program/" + params["wizardid"]
...
def CreateJsonSchemas():
    ...
    err500Schema = CreateJsonSchema(
        "GET response schema for /api/v1/wizard/washing-program/{wizardid} requests: ERROR 500", 
        "Wizard response schema", 
