...
@pytest.mark.prod
def test_get_recipes_allergens_lang(token: str, params: dict):
    url = "https://api.connectlife.io/api/v1/recipes/allergens/" + params["lang"]
...
def CreateJsonSchemas():
    ...
    success200Schema = CreateJsonSchema(
        "GET response schema for /api/v1/recipes/allergens/{lang} requests: SUCCESS 200", 
    ...
    err500Schema = CreateJsonSchema(
        "GET response schema for /api/v1/recipes/allergens/{lang} requests: ERROR 500", 
        "Recipe response schema", 
