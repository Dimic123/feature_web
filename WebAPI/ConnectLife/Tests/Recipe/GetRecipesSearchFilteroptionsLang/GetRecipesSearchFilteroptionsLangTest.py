...
@pytest.mark.prod
def test_get_recipes_search_filter_options_lang(token: str, params: dict):
    url = "https://api.connectlife.io/api/v1/recipes/" + params["lang"]
...
def CreateJsonSchemas():
    ...
    success200Schema = CreateJsonSchema(
        "GET response schema for /api/v1/recipes/{lang} requests: SUCCESS 200", 
    ...
    err500Schema = CreateJsonSchema(
        "GET response schema for /api/v1/recipes/{lang} requests: ERROR 500", 
        "Recipe response schema", 
