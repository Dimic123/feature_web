...
def CheckIfHome(driver: webdriver) -> bool:
    try:
        driver.find_element(
            by=AppiumBy.XPATH, value='//android.view.View[@content-desc="PULL TO REFRESH"]')
    except:
        return False
    else:
        return True
...
def CheckIfBottomBar(driver: webdriver) -> bool:
    try:
        driver.find_element(by=AppiumBy.XPATH,
                            value='//android.view.View[@content-desc="Home"]')
        driver.find_element(
            by=AppiumBy.XPATH, value='//android.view.View[@content-desc="Devices"]')
        driver.find_element(by=AppiumBy.XPATH,
                            value='//android.view.View[@content-desc="Menu"]')
        driver.find_element(
            by=AppiumBy.XPATH, value='//android.view.View[@content-desc="Show menu"]')
    except:
        return False
    else:
        return True
